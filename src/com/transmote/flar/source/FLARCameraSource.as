...
package com.transmote.flar.source {
	...
	public class FLARCameraSource extends Sprite implements IFLARSource {
		...
		private var _sourceDirty:Boolean;
...
//			this.addChild(this.sampleBitmap);
		...
		/**
		 * Retrieve the <code>BitmapData</code> source used for analysis.
		 * NOTE: returns the actual <code>BitmapData</code> object, not a clone.
		 */
		...
		/**
		 * Size of <code>BitmapData</code> source used for analysis.
		 */
		...
		/**
		 * Returns <code>true</code> if the camera view has changed more than <code>activityThreshold</code> this frame.
		 */
